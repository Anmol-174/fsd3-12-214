...
const main = async ()=>{
    ...
    do{
    console.log("Welcome to filpcart 😊");
    console.log("1 -------- Show cart ");
    console.log("2--------- Add Prodcut");
    console.log("3----------Remove Product");
    console.log("4---------- Update Quatity");
    console.log("5---------- Exit");
 ...
 switch(Number(choice)){
    ...
    case 2:
        ...
        const [ id, name, price, qty] = data.split(" , ")
        .map(item => item.trim());
        const product = {
            id: Number (id),
            name,
  ...
  do {
    ...
    switch (Number(choice)) {
      ...
      case 2:
        ...
        break;
      case 3:
        let pid = cin.question("enter product id to remove");
